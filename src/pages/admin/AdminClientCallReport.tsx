...
export default function AdminClientCallReport() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .maybeSingle()
      .then(({ data }) => {
        if (data) setClientName(data.name || data.company || leadId);
      });
  }, [leadId]);
  ...
  return (
    <div className="space-y-6 p-6" data-testid="call-report-page">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-heading">Call Report</h1>
            <p className="text-muted-foreground">{clientName || 'Loading…'}</p>
          </div>
        </div>
        <div className="flex items-center gap-2 flex-wrap">
          <Select value={period} onValueChange={setPeriod}>
            <SelectTrigger className="w-44" data-testid="period-picker">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              {periodOptions.map((o) => (
      ...
      <div className="grid gap-4 lg:grid-cols-5">
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent>
            {dailyData.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={220} data-testid="bar-chart">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent data-testid="disposition-chart">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
            ...
            <div className="flex gap-2 flex-wrap">
              ...
              <Select value={dispositionFilter || 'all'} onValueChange={(v) => setDispositionFilter(v === 'all' ? '' : v)}>
                <SelectTrigger className="w-40" data-testid="disposition-filter">
          ...
          {logs.isLoading ? (
            ...
            <>
              <div className="overflow-x-auto">
                <Table data-testid="call-log-table">
                  <TableHeader>
                    <TableRow>
