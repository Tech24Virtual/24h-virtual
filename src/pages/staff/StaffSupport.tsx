...
function StaffSupportPage({ role }: StaffSupportProps) {
  const { user } = useAuth();
        ...
        <div className="rounded-2xl border border-border p-6 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-0.5">Submit a request or ask PiP AI for instant guidance</p>
            </div>
          </div>
        </div>
...
export default function StaffSupport({ role }: StaffSupportProps) {
  return <StaffSupportPage role={role} />;
}
